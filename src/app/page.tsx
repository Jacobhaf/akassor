...
export default function Home() {
    ...
    return (
        <div className="flex flex-col min-h-screen font-sans">
            {/* Hero Section */}
            <div className="relative bg-[#0B1B3F] py-24 sm:py-32 border-b border-slate-700">
                <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center">
                    <div className="mx-auto max-w-3xl">
                        ...
                        <div className="mt-10 mb-8 w-full max-w-lg mx-auto bg-white p-1 rounded-lg border border-slate-300 shadow-lg">
                            <Search />
                        </div>
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="grid md:grid-cols-3 gap-12">
                        <div className="bg-white p-8 rounded-lg border border-slate-200">
                            <div className="w-12 h-12 bg-slate-900 rounded flex items-center justify-center text-white font-bold text-xl mb-6">
                                1
                            </div>
                            <h3 className="font-bold text-xl mb-3 text-slate-900">Välj yrke eller se lista</h3>
                        ...
                        <div className="bg-white p-8 rounded-lg border border-slate-200">
                            ...
                            <h3 className="font-bold text-xl mb-3 text-slate-900">Jämför avgifter & villkor</h3>
                        ...
                        <div className="bg-white p-8 rounded-lg border border-slate-200">
                            ...
                            <h3 className="font-bold text-xl mb-3 text-slate-900">Gå med eller byt</h3>
            ...
            <section className="py-24 bg-slate-900 text-white">
                <div className="max-w-4xl mx-auto px-6">
                    ...
                    <div className="space-y-6">
                        {faqs.map((faq, i) => (
                            <div key={i} className="bg-white/5 border border-white/10 rounded-lg p-6 hover:bg-white/8 transition-colors">
